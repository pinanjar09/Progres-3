...
<div class="breadcrumbs_options" style="margin-bottom: 10px;">
    ...
    <a href="<?=BASE_URL;?>/category/all"><?=$this->e($front_category);?>&nbsp;</a><i class="fa fa-angle-right yellow"></i>
    <a href="<?=$this->e($social_url);?>"><span class="current"><?=$this->e($page_title);?></span></a>
</div>
<h3 class="categories-title title"><?=$this->e($front_category);?> <?=$this->e($page_title);?></h3>
