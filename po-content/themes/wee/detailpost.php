		...
		<div class="post type-post status-publish">
			...
			<div class="single_post_title heading_post_title">
				...
				<div class="love_this_post_meta">
					<a href="#" class="jm-post-like" title="Like"><i class="fa fa-eye"></i><?=$post['hits'];?></a>
				</div>
			</div>
			...
			<div class="postnav">
				...
				<a href="<?=BASE_URL;?>/detailpost/<?=$prevpost['seotitle'];?>" id="prepost"><?=$prevpost['title'];?></a>
				</span>
                <?php } ?>
                <?php
				...
				<a href="<?=BASE_URL;?>/detailpost/<?=$nextpost['seotitle'];?>" id="nextpost"><?=$nextpost['title'];?></a>
				</span>
                <?php } ?>
			</div>
			<hr class="none">
			...
			<div class="related-posts">
				<div class="widget-title">
					<h2><?=$this->e($front_related_post);?></h2>
				</div>
				<div class="clearfix"></div>
                <?php
				    $norelated = 1;
                ...
                <div class="feature-four-column medium-four-columns appear_animation">
					<div class="image_post feature-item">
						<a href="<?=BASE_URL;?>/detailpost/<?=$related['seotitle'];?>" class="feature-link" title="<?=$related['title'];?>"><img width="400" height="260" src="<?=BASE_URL;?>/<?=DIR_CON;?>/uploads/medium/medium_<?=$related['picture'];?>" class="attachment-medium-feature size-medium-feature" alt="images"/><span class="overlay_icon fa fa-volume-up"></span></a>
                    </div>
					<h3 class="image-post-title columns_post"><a href="<?=BASE_URL;?>/detailpost/<?=$related['seotitle'];?>"><?=$related['title'];?></a></h3>
					<p class="post-meta meta-main-img">
						<span class="post-date"><i class="fa fa-clock-o"></i><?=$this->pocore()->call->podatetime->tgl_indo($related['date']);?></span>
                        <span class="meta-comment"><a href="<?=BASE_URL;?>/detailpost/<?=$related['seotitle'];?>#comments"><i class="fa fa-comments"></i><?=$this->post()->getCountComment($related['id_post']);?> <?=$this->e($front_comment);?></a></span>
					</p>
				</div>
				<?php } ?>
			</div>
					...
					<div id="comments" class="comments-area">
						...
						<div id="respond" class="comment-respond">
							...
							<form id="commentform" class="comment-form" action="<?=BASE_URL;?>/detailpost/<?=$post['seotitle'];?>#comments" method="post">
