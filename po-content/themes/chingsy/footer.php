<footer id="footer" class="dark">
	...
	<div id="copyrights">
		<div class="container clearfix">
			<div class="col_half">
				Copyrights © <?=date('Y');?> All Rights Reserved by <?=$this->pocore()->call->posetting[0]['value'];?><br>
			...
			<div class="col_half col_last tright">
				...
				<div class="clear"></div>
				<i class="icon-envelope2"></i> <?=$this->pocore()->call->posetting[5]['value'];?> <span class="middot">·</span> <i class="icon-headphones"></i> <?=$this->pocore()->call->posetting[6]['value'];?>
			</div>
		</div>
	</div>
</footer>